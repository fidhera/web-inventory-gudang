...
<li>
<a href="https://github.com/fidhera" target="_blank"><i class="fa fa-github fa-fw fa-2x"></i></a>
</li>
<li>
<a href="https://www.linkedin.com/in/" target="_blank"><i class="fa fa-linkedin fa-fw fa-2x"></i></a>
</li>
</ul>
<hr class="medium">
<p class="text-muted" style="font-size: 16px;">Tugas Ujian &copy;<script>document.write(new Date().getFullYear());</script> Pemrograman Web Jonathan dan Raffael</p>
</div>
</section>
</footer>
